    ...
    <div class="content_wrap">
      <div class="logo"><img src="/greencometdev/images/logo.png" alt="green comet"></div>
       <div class="signin_cont">
	          <div class="signin"><a id="simple-link-53bcdcd67eb58" href="#">sign in</a></div>
        <div class="signin"><a id="simple-link-53bcdcd67ef40" href="#">sign up</a>		</div>
		      </div>
    </div>
  </header>-->
...
<form id="create-task-form" action="/greencometdev/poster/createtask" method="post">
