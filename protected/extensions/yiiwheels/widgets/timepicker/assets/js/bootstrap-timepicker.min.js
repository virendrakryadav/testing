...
(function (e, t, n, r) {
    ...
    i.prototype = {constructor: i, _init: function () {
        ...
        if (this.$widget === !1)return;
        var t = e(".bootstrap-timepicker-hour", this.$widget).val() + ":" + e(".bootstrap-timepicker-minute", this.$widget).val() + (this.showSeconds ? ":" + e(".bootstrap-timepicker-second", this.$widget).val() : "") + (this.showMeridian ? " " + e(".bootstrap-timepicker-meridian", this.$widget).val() : "");
        this.setTime(t)
