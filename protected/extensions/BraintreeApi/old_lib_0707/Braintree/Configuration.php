...
class Braintree_Configuration extends Braintree
{
    ...
    public static function caFile($sslPath = NULL)
    {
       ...
       // echo $caPath;
      //echo   $caPath = 'D:\xampp\htdocs\greencometdev\protected\extensions\BraintreeApi\lib\ssl\sandbox_braintreegateway_com.ca.crt';
         $caPath = 'D:\xampp\htdocs\greencometdev\sandbox_braintreegateway_com.ca.crt';
