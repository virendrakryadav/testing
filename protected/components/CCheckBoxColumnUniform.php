...
class CCheckBoxColumnUniform extends CCheckBoxColumn
{/**
                           ...
                           function checkboxesrefresh()
                            {
                                ...
                                $("input:checked").each(function(index,value) {
                                    marked[k] = value;
                                   var markedID = marked[k].id;

                                     $('#'+markedID+'').closest("span").addClass("checked");
                                    k++;
                                });
                                $("input:checkbox:not(:checked)").each(function(index,value) {
                                    markedUnchek[j] = value;
                                    var unmarkedID = markedUnchek[j].id;

                                     $('#'+unmarkedID+'').closest("span").removeClass("checked");
