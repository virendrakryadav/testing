<div class="controls-row" style="width:97.7%;"> 
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'portfolio-grid-post',
        'dataProvider' => $task->userPostList(),
        //'filter'=>$model,
         'emptyText' => Yii::t('index_updateprofile','msg_no_portfolio_post'),
        'ajaxUpdate' => true,
        'columns' => array(
...
//            ),
            ...
            array(
                ...
                'type' => 'html',
                'value' => 'UtilityHtml::getDeleteImage($data["task_id"],$data["ref_verification_status"],"portfolio-grid-post")',
                'headerHtmlOptions' => array(
                    'class' => 'grid_status',
                ),
                'htmlOptions' => array(
