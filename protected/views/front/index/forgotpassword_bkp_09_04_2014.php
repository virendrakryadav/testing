    ...
    <div class="create_account_popup">
      ...
      <div class="create_acunt_inner">
		...
		<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
				...
				'action' => Yii::app()->createUrl('index/forgotpassword'), 
		...
		echo CHtml::ajaxSubmitButton(CHtml::encode(Yii::t('index_forgotpassword','btn_txt_send')),Yii::app()->createUrl('index/forgotpassword'),array(
			   ...
			   'success'=>'js:function(data){
				   ...
				   //alert("if");
					  $(".sign_form").html("'.CHtml::encode(Yii::t('index_forgotpassword','txt_success_msg_your_password_send_to_your_mail_id_successfully')).'");
					  //window.location.href="'.Yii::app()->createUrl('index/dashboard').'";
				   }
				   else if(data.status === "not"){
					  $("#error").html("'.CHtml::encode(Yii::t('index_forgotpassword','txt_success_msg_your_password_send_to_your_mail_id_successfully')).'");
				   }
				   else{	
				   //alert("else");			   	
