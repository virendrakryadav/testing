...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
		...
		'clientOptions' => array(
			...
			<div class="sign_row2">
				...
				<div class="sign_row popup_padding">

				<?php echo $form->textFieldControlGroup($model, Globals::FLD_NAME_EMAIL, array('labelOptions' => array("label" => false), 'prepend' => '<i class="icon-user"></i>', 'placeholder'=> CHtml::encode(Yii::t('index_forgotpassword','txt_fld_email_placeholder')))); ?>
                                                
				

				  <?php //echo $form->textField($model,'email',array('placeholder'=> CHtml::encode(Yii::t('blog','E-mail id')))); ?>

				<?php //echo $form->error($model,Globals::FLD_NAME_EMAIL); ?>
		...
		echo CHtml::ajaxSubmitButton(CHtml::encode(Yii::t('index_forgotpassword','btn_txt_send')),Yii::app()->createUrl('index/forgotpassword'),array(
			...
			),array('class'=>'sign_bnt','id'=>'forgetpasswordsubmit'));
