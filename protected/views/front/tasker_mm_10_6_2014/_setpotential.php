...
?>
<a id="setpotential<?php echo $id ?>" title="<?php echo Yii::t('tasklist','Add to favorite list') ?>" onclick="setpotential('<?php echo $bookmark_type; ?>','<?php echo $id; ?>')" href="javascript:void(0)"><img src="<?php echo CommonUtility::getPublicImageUri( "unfevorite.png" ) ?>"></a>