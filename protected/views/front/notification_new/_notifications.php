...
<div class="pro_tab">
    <h2 class="h2"> <?php echo Yii::t('index_profile', 'txt_notification') ?></h2>
...
//        'tabs' => array(
//        array('label' => Yii::t('index_profile', 'Instant task'), 'content' => $this->renderPartial('//notification/_notificationsinstant', array('model' => $model, 'notifications' => $notifications), true, false), 'active' => true),
//        array('label' => Yii::t('index_profile', 'In-person task'), 'content' => $this->renderPartial('//notification/_notificationsinperson', array('model' => $model, 'notifications' => $notifications), true, false)),
//        array('label' => Yii::t('index_profile', 'Virtual task'), 'content' => $this->renderPartial('//notification/_notificationsvirtual', array('model' => $model, 'notifications' => $notifications), true, false)),
