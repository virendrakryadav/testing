...
<div class="clr"></div>-->
    <h2 class="heading-md color-orange"><?php echo Globals::DEFAULT_APP_NAME_ERANDOO;?></h2>
</div>
<div class="col-md-12">
...
<!--<button  id='menu-selected-item' data-toggle="dropdown" class="form-control das-input dashome" type="button">
<i class="fa fa-home home-size18"></i>
Dashboard
</button>-->
<button id='menu-selected-item' data-toggle="dropdown" class="form-control das-input dashome" type="button" style="margin-bottom: 0px;">
Dashboard
