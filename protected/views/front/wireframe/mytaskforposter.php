...
<h2 class="h2 text-30a">My Posted Projects</h2>
...
<div class="proposal_col4 ">Post date: <span class="date">May 30, 2014 </span></div>
<div class="proposal_col4 ">Bid end date: <span class="date">Jun 11, 2014</span></div>
...
<div class="proposal_col4 ">Estimated price: <span class="date">$105</span></div>
<div class="proposal_col4 ">Location: <span class="date">Anywhere</span></div>
...
<div class="total_task3"><input type="button" name="" value="Invite" class="btn"></div>
</div>
