<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="prvlist_box">
		...
		<?php //echo $form->textField($task,'dfgds',array('size'=>60,'maxlength'=>100,'class'=>'span6'));?>
               ...
               <div><?php echo Yii::t('tasker_mytasks', 'Keyword')?></div>
               <?php //echo $form->label($task,'title',array('class'=>'control-label','label'=>Yii::t('admin_category_search','category_status_text'))); ?>
               <div><?php echo Yii::t('tasker_mytasks', 'City')?></div>
               <input type="text">
               <div><?php echo Yii::t('tasker_mytasks', 'Zip')?></div>
               <input type="text">
               <div><?php echo Yii::t('tasker_mytasks', 'Select Category')?></div>
               <input type="text">
