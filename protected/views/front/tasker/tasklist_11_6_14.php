...
<div class="container content">
        ...
        <div class="margin-bottom-30">
            <div id="accordion" class="panel-group">
                <div class="panel panel-default margin-bottom-20 sky-form">
                    <div class="panel-heading"><h3 class="panel-title"><a href="#collapseOne" data-parent="#accordion" data-toggle="collapse"><?php echo CHtml::encode(Yii::t('tasklist', 'Filter'));?>
                            <span class="accordian-state"></span></a></h3> 
                    </div>

                    <div class="panel-collapse collapse in sky-form" id="collapseOne">
                        <!--Save filter starts here-->
                        ...
                        <div class="filter_cont">
                            ...
                            <?php echo CHtml::hiddenField( Globals::FLD_NAME_QUICK_FILTER , "", array('id' => 'quickFilterValue')); ?>          
                                <ul>
                                    <?php 
                                        ...
                                        $endingToday = ($quickFilter == Globals::FLD_NAME_ENDING_TODAY) ? 'activeCategory' : '' ;
                                        $fewProposals = ($quickFilter == Globals::FLD_NAME_FEW_PROPOSALS) ? 'activeCategory' : '' ;
                                    ?>
                                    <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'Ending Today')), 'javascript:void(0)', array('id' => 'loadEndingToday' , 'class' => $endingToday)); ?></li>
                                    <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'Few Proposals')), 'javascript:void(0)', array('id' => 'loadFewProposals' , 'class' => $fewProposals)); ?></li>
                                    ...
                                    <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'Previously worked')), 'javascript:void(0)', array('id' => 'loadPreviouslyWorked' , 'class' => $previouslyWorked)); ?></li>
                                    <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'Past Relationships')), 'javascript:void(0)', array('id' => 'loadPotential' , 'class' => $potential)); ?></li>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="advncsearch">
                                <div class="advnc_row margin-bottom-10"><?php echo CHtml::encode(Yii::t('poster_mytasklist', 'Task type'));?></div>
                                <div class="col-md-12 pdn-auto">
                                    <div class="col-md-12 no-mrg"><?php  UtilityHtml::getTaskTypeDropDown( "taskType" , (isset($_GET["taskType"])) ? $_GET["taskType"] : ''   ); ?></div>
                                </div>
                            </div> 
    ...
    <div class="col-md-9 sky-form">
        <h2 class="h2 text-30a"><?php echo CHtml::encode(Yii::t('poster_mytasklist', 'Projects List'));?></h2>     
        <div class="margin-bottom-30">
            <div class="sortby-row margin-bottom-20"> 
                <div class="ntointrested"> </div>                     
        ...
        <div id="loadData " class="col-md-12 no-mrg positionRelativeClass">
                <?php
