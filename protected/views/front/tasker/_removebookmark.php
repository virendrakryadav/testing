...
?>
<a id="unsetpotential<?php echo $id ?>" title="<?php echo Yii::t('tasklist','Remove from favorite list') ?>" onclick="unsetpotential('<?php echo $bookmark_type; ?>','<?php echo $id; ?>')" href="javascript:void(0)"><img src="<?php echo CommonUtility::getPublicImageUri( "unfevorite.png" ) ?>"></a>