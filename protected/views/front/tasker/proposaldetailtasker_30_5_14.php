...
<!--                    <h3 class="h3 bot_border"><?php echo Yii::t('tasker_mytasks', 'Review')?></h3>
                        <div class="proposal_row3 botmrgn">
                            ...
                            <div class="reviewcol"><span class="counttext"><?php echo Yii::t('tasker_mytasks', 'Average rating')?></span> 
...
//                                            ));
                            ...
                            ?> 
<!--                        <div class="write_but">
                            <div class="messagesend"><a href="#" class="btn-u rounded btn-u-blue">View all</a></div>
                        </div>-->
                  </div>
...
<!--                  <div class="tasker_row1">
                     ...
                     <div class="writemess_cont">
                        ...
                        <div class="write_but">
                            <div class="messagesend"><input name="" type="button" value="Send" class="btn-u rounded btn-u-sea" /></div>
                        </div>
                     </div>
                  </div>-->
