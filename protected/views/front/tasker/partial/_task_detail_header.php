...
<div class="proposal_col4 "><?php echo Yii::t('poster_createtask', 'lbl_posted')?>: <span class="date"><?php echo CommonUtility::formatedViewDate($task->{Globals::FLD_NAME_CREATED_AT}) ?> </span></div>
<div class="proposal_col4 "><?php echo Yii::t('poster_createtask', 'lbl_start_date')?>: <span class="date"><?php echo CommonUtility::formatedViewDate($task->{Globals::FLD_NAME_CREATED_AT}) ?> </span></div>
<div class="proposal_col4 "><?php echo Yii::t('poster_createtask', 'lbl_type')?>: <span class="date"><?php echo ucwords(UtilityHtml::getTaskType($task->{Globals::FLD_NAME_TASK_KIND})); ?> </span></div>
<div class="proposal_col4 "><?php echo Yii::t('poster_createtask', 'lbl_category')?>: <span class="date"><?php echo $task->categorylocale->{Globals::FLD_NAME_CATEGORY_NAME} ?> </span></div>
</div>  
</div>
