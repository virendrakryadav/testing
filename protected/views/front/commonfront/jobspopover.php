...
<?php if($tasks)
{
    ...
    {
        ?>
    <div class="col-md-12 margin-bottom-10 align-center"><a target="_blank" href="<?php echo CommonUtility::getTaskSearchUrlByUserJobs($user_id) ?>" class="color-orange">View All</a></div>
        <?php
    }
}
else
{
    echo 'No jobs has been completed yet.';
}
?>
