...
<p class="tasker_name"><a target="_blank" href="<?php echo CommonUtility::getTaskerProfileURI($tasker->{Globals::FLD_NAME_TASKER_ID}) ?>"><?php echo CommonUtility::getUserFullName($tasker->{Globals::FLD_NAME_TASKER_ID}); ?>
