    ...
    <div class="controls-row">
        ...
        <div class="controls-row">
            ...
            <div class="controls-row">
                ...
                <!--      getTaskThumbnailImageURI($id,$size)-->
            ...
            <div class="taskcount">
                ...
                <div class="datecount_col1"><?php echo UtilityHtml::getBidStatus($task->{Globals::FLD_NAME_TASK_FINISHED_ON}); ?></div>
            </div>
        </div>
        ...
        <div class="controls-row">
            ...
            <div class="controls-row"><div class="name_ic"><img src="../images/vis-ic.png"></div>
                <?php echo CommonUtility::getPublicDetail($task->{Globals::FLD_NAME_IS_PUBLIC}); ?></div>
        </div>
        <div class="controls-row">
    ...
    <div class="controls-row cnl_space">
        <div class="btn_cont">
            ...
            <?php echo CHtml::ajaxLink(CHtml::encode(Yii::t('poster_createtask', 'txt_edit')), Yii::app()->createUrl('poster/loadcategoryformtoupdate'), array(
                ...
                'dataType' => 'json', 
                'data' => array('taskId' => $task->{Globals::FLD_NAME_TASK_ID}, 'category_id' => $category[0]->categorylocale->category_id, 'formType' => 'inperson'), 
                'type' => 'POST', 
                ...
                array('id' => 'editinpersontask', 'class' => 'ancor_bnt', 'live' => false)); ?>
            </div>        
            <?php
            ...
            if ($task->{Globals::FLD_NAME_VALID_FROM_DT} != Globals::DEFAULT_VAL_VALID_FROM_DT ) 
            {
              ...
              // echo $task->{Globals::FLD_NAME_TASKER_ID_SOURCE};
        ...
        <?php
            ...
            else 
            {
                ...
                $successUpdatePublish = '
                                    ...
                                    ';
                CommonUtility::getAjaxSubmitButton(CHtml::encode(Yii::t('poster_createtask', 'lbl_publish')), Yii::app()->createUrl("poster/publishtask"), 'ancor_bnt2', 'useraddTask', $successUpdatePublish);
            ?>
                </div>
                <?php
