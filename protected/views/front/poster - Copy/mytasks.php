    ...
    <?php $this->renderPartial('//tasker/instantnavigation',array('type' => Globals::DEFAULT_VAL_USER_ROLE_POSTER 
        ...
        <div class="box">
            ...
            <div id="loadactionfilter">
                ...
                $this->renderPartial('//tasker/_actionfilters',array('filter_type' => Globals::DEFAULT_VAL_ATTRIB_TYPE_FILTER_POSTED_MYTASKS ,'action_url' => Yii::app()->createUrl('poster/filterformmytasks')));
            ...
            <div class="filter_cont">
                ...
                <div class="smartsearch">
                    <div id="tasklist">
                    <?php
                    $all = ($state == Globals::DEFAULT_VAL_NULL) ? 'activeCategory' : '' ;
                    $statusOpen = ($state == Globals::DEFAULT_VAL_TASK_STATUS_OPEN) ? 'activeCategory' : '' ;
                    $statusFinished = ($state == Globals::DEFAULT_VAL_TASK_STATUS_FINISHED) ? 'activeCategory' : '' ;
                    $statusAwarded = ($state == Globals::DEFAULT_VAL_TASK_STATUS_ACTIVE) ? 'activeCategory' : '' ;
                    $statusCancel = ($state == Globals::DEFAULT_VAL_TASK_STATUS_CANCELED) ? 'activeCategory' : '' ;
                    ?>
...
<?php $this->renderPartial('//tasker/_getfilters', array('taskType' => $taskType,  'maxPrice' => $maxPrice ,'minPrice' => $minPrice , 'date' => $date , 'rating' => $rating , 'maxPriceValue' => $maxPriceValue , 'minPriceValue' => $minPriceValue , 'parentCategory' => $parentCategory , 'subCategoryName' => $subCategoryName ,  'filter_type' => Globals::DEFAULT_VAL_ATTRIB_TYPE_FILTER_POSTED_MYTASKS ,'taskName' => $taskName));?>
    ...
    <div class="rightbar">
        <div class="box">
            ...
            <div id="sorterRow" style="display: <?php if($mytasklist->getTotalItemCount() > 0 ) echo 'block'; else echo 'none'; ?>" class="sortby_row">                                                               
<!--                <div class="ntointrested">Found 50 results</div>-->
                <div class="sortby">
                     <?php echo UtilityHtml::getSortingDropDownTaskSearch( "sort" , array( 'id' => 'sortDrop' , 'class' => 'span2' ) ); ?>
                </div>
            </div> 
            ...
            <?php
                $this->widget('ListViewWithLoader', array(
                    ...
                    'itemView' => '_mytasks',
                     'enableHistory' => true,
                    'summaryText' => Yii::t('tasklist','Found {count} tasks'),
