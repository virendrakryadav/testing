...
<div class="invite-row2" onclick="addTaskerToInvite('<?php echo $data->{Globals::FLD_NAME_USER_ID} ?>','<?php echo CommonUtility::getUserFullName( $data->{Globals::FLD_NAME_USER_ID} ); ?>' , '<?php echo $img ?>' , 'invitedTaskers'  )">
