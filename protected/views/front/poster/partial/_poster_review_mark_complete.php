...
<div class="project-col3"><a href="#"  onclick="cancelReview()">
        <span><img src="<?php echo CommonUtility::getPublicImageUri("project-cancel-btn.png") ?>"></span>
<span>Cancel</span>
</a></div>
<div class="project-col4"><a href="#" onclick="goStep2()" ><img src="<?php echo CommonUtility::getPublicImageUri("project-complete-btn.png") ?>">
