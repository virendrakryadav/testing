...
<div class="controls-row pdn6 "> 
    <div class="proposal_list <?php if($isPremium) echo 'task_list'; else echo 'task_list2' ?>">
        <?php
        if($hired > 0)
        {
            ?>
...
<div class="ratingtsk">
   <?php echo UtilityHtml::getDisplayRating($data->{Globals::FLD_NAME_TASK_DONE_RANK}); ?>
</div></div>
...
//                                        'class' => 'interested_btn', 'live' => false));
                ...
                <div style="margin-right:5px;" class="tasker_col5">
                    <input class="interested_btn" type="submit" value="<?php echo CHtml::encode(Yii::t('poster_findtasker', 'txt_connect_me'));?>">
                    <?php
