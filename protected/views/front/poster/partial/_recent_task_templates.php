...
{
     echo Chosen::dropDownList('recent_task_template', '', $selectTemplate,
     array('prompt'=> CHtml::encode(Yii::t('poster_createtask', 'Use Recent Project As Template')),
                                    ...
                                    else
                                    {
                                      ...
                                      'data' => array('task_id'=>'js:this.value')),'class' => 'form-control mrg3 selectbg','id' => 'load_recent_template' , 'live'=>false));
