                ...
                <div class="span4 nopadding">
                    ...
                    <div class="span3 nopadding">
                        ...
                        if (isset($task->{Globals::FLD_NAME_TASK_START_DATE})) {
                            echo $date = $task->{Globals::FLD_NAME_TASK_START_DATE};
...
<!--                    <div class="startby span2">
                        <?php //echo $form->textField($task, Globals::FLD_NAME_WORK_HRS, array('class' => 'span2 startby nomargin', 'max' => 2, 'placeholder' => CHtml::encode(Yii::t('poster_createtask', 'txt_task_hours')),'readonly'=>$is_public)); ?>
