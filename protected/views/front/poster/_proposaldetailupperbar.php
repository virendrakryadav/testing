...
<div class="col-md-7 no-mrg"><h3 class="pro-title"><?php echo ucfirst($task->{Globals::FLD_NAME_TITLE}) ?></h3></div>
...
<div class="proposal_col4 "><?php echo Yii::t('tasker_proposaldetail','Start Date');?>: <span class="date"><?php echo CommonUtility::formatedViewDate($task->{Globals::FLD_NAME_TASK_BID_CLOSE_DATE}) ?></span></div>
