    ...
    <div class="page-container page_padding">
        ...
        <div class="controls-row">
            ...
            <div class="profile_name"><h1><?php echo CommonUtility::getUserFullName($model->{Globals::FLD_NAME_USER_ID}); ?>&nbsp<span class="tagline"><?php echo $model->{Globals::FLD_NAME_COUNTRY_CODE}; ?></span></h1>
                <span class="tagline"><?php echo $model->{Globals::FLD_NAME_TAGLINE}; ?></span>
            </div>
        </div>
        ...
        <div class="rightbar">
            <div class="box">
                ...
                <div class="controls-row pdn">
                    <h3 class="h3"><?php echo CHtml::encode(Yii::t('poster_confirmtask', 'lbl_specialities')) ?></h3>
                    <?php $skills = UtilityHtml::userSkills($model->{Globals::FLD_NAME_USER_ID}, "span4 nopadding specialties", Globals::DEFAULT_VAL_SKILLS_DISPLAY_IN_COLUMN) ;
                        if( $skills )
                        {
                            echo $skills;
                        }
