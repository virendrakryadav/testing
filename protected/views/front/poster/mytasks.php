...
$currentPageUrl = CommonUtility::getMyTaskListURI();
$date = '';
...
//        )); 
        ...
        <?php /* $this->renderPartial('//tasker/instantnavigation',array('type' => Globals::DEFAULT_VAL_USER_ROLE_TASKER  , 'menusLinks' => 
                array(
                     CHtml::encode(Yii::t('poster_projectdetail', 'txt_search_members')) => CommonUtility::getPosterSearchMembersUrl() ,
                    )
        ));*/  ?>
        <!--Filter start here-->
        <div class="margin-bottom-30">
                            ...
                            <!--Start search start here-->
                                ...
                                <div class="message-filter">
                                    ...
                                    ?>
                                        ...
                                        <ul>
                                            <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'txt_currently_hiring')), 'javascript:void(0)', array('id' => 'loadmytasksOpen' , 'class' => $statusOpen)); ?></li>
                                            <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'txt_active_projects')), 'javascript:void(0)', array('id' => 'loadmytasksAwarded' , 'class' => $statusAwarded)); ?></li>
                                            <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'txt_completed_projects')), 'javascript:void(0)', array('id' => 'loadmytasksClose' , 'class' => $statusFinished)); ?></li>
                                            <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'txt_cancel_projects')), 'javascript:void(0)', array('id' => 'loadmytasksCancel' , 'class' => $statusCancel)); ?></li>
                                            <li><?php echo CHtml::link(CHtml::encode(Yii::t('poster_mytasklist', 'txt_all_projects')), 'javascript:void(0)', array('id' => 'loadmytasksAll' , 'class' => $all )); ?></li>
...
//                          echo CHtml::dropDownList(Globals::FLD_NAME_PROJECT_SEARCH_DURATION,$searchProjectValue,$searchProjectOption,array('class' => 'form-control'));                        
                    ...
                    <button type="button" id="searchByTaskTitle" class="btn-u rounded btn-u-sea"><?php echo Yii::t('poster_createtask', 'lbl_search')?> </button></div>
            </form>
        </div>  
        ...
        <div class="sortby-row margin-bottom-10"> 
                ...
                <div class="sortby-cat btn btn-xs rounded btn-default" id="categoryClick">
                    <?php echo Yii::t('poster_createtask', 'lbl_category')?>                                        
                </div> 
...
<!--                                <input type="hidden" value="/a" name="taskType" id="taskType">-->
        ...
        <div id="loadData " class="margin-bottom-30 positionRelativeClass">            
                ...
                $this->widget('ListViewWithLoader', array(
                    'id' => 'loadmytasksdata',
                    'emptyText' => '<div class="items overflow-h"><div class="alert alert-danger fade in" id="msgshow">'.Yii::t('tasklist','txt_no_project_found').'.</div></div>',
