...
<!--                <span style="margin-top:-0.7em;padding:2px;"><?php echo UtilityHtml::getDisplayRating($data->{Globals::FLD_NAME_RANK}); ?></span>-->
            ...
            <div class="proposal_col2">
                <div class="proposal_row">
                    <p class="task_name"><a href="<?php echo $taskDetailUrl; ?>"><?php echo ucfirst($data->{Globals::FLD_NAME_TITLE}) ?></a></p>
...
<div class="total_task3">
    <input type="button" name="" onclick="editTask('<?php echo $data->{Globals::FLD_NAME_TASK_ID} ?>' , '<?php echo $data->categorylocale->category_id ?>' , '<?php echo  UtilityHtml::getTaskType($data->{Globals::FLD_NAME_TASK_KIND}) ?>')" value="<?php echo CHtml::encode(Yii::t('poster_createtask', 'Edit')) ?>" class="btn">
</div>
