...
<!--	<p class="note">Fields with <span class="required">*</span> are required.</p>-->
	...
	<div class="control-group">
		...
		<div class="controls">
		<?php echo $form->textField($model,'country_code',array('class'=>'span6','style' => 'text-transform: uppercase')); ?><span class="help-inline"><?php echo $form->error($model,'country_code'); ?></span></div>
...
<!--            <div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls"><?php echo $form->textField($locale,'country_name',array('class'=>'span6')); ?>
                    <span class="help-inline">
	...
	<div class="control-group">
		...
		<?php echo $form->textField($locale,'country_priority',array('size'=>3,'maxlength'=>3,'class'=>'span6', 'value'=>$this->maxPriority)); ?>
            <span class="help-inline"><?php echo $form->error($locale,'country_priority'); ?></span></div>
	</div>
	...
	<div class="control-group">
		...
		<span class="help-inline"><?php echo $form->error($locale,'country_status'); ?></span></div>
	</div>
