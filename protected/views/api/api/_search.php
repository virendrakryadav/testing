...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="span2">
		...
		<?php echo $form->textField($model,'firstname',array('class'=>'span12', 'value'=>CommonUtility::createValue($fillFields,'user_firstname'))); ?>
                </div>
	</div>
    </div>
    ...
    <div class="span2">
		...
		<div class="controls"> 
		<?php echo $form->textField($model,'phone',array('class'=>'span12', 'value'=>CommonUtility::createValue($fillFields,'user_phone'))); ?>
                </div>
	</div>
    </div>
