...
?>
<?php CommonUtility::adminUserFormScript(); ?>
...
<!--  <p class="note">Fields with <span class="required">*</span> are required.</p>-->
  ...
  <div class="control-group"> <?php echo $form->labelEx($model,'repeatpassword',array('class'=>'control-label','label'=>Yii::t('admin_admin_form','repeatpassword_text'))); ?>
    <div class="controls"> <?php echo $form->passwordField($model,'repeatpassword',array('class' => 'Select_box span6')); ?> <span class="help-inline"> <?php echo $form->error($model,'repeatpassword'); ?> </span> </div>
  </div>
  <?php
  }
  ?>
  ...
  <div class="control-group"> <?php echo $form->labelEx($model,'user_roleid',array('class'=>'control-label','label'=>Yii::t('admin_admin_form','user_roleid_text'))); ?>
    ...
    <div class="controls">
        <?php echo $form->dropDownList($model,'user_roleid',$list, array('empty' => 'Select Admin Role','class' => 'Select_box span6')); ?>
