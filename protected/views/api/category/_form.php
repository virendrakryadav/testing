...
<?php if(!$model->isNewRecord){
   echo $form->hiddenField($locale, 'category_id');
	...
	<div class="control-group">
		...
		<span class="help-inline"><?php echo $form->error($locale,'category_name'); ?></span></div>		
	</div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    if(!empty($locale->category_image))
                            {
                               $imageName =  Globals::BASH_URL.'/'.Globals::CATEGORY_IMAGE_UPLOAD_PATH.$locale->category_image;
                            }
                            else
                                {
...
//                             array('prompt'=>'--Select Parent Category--', 'class' => 'span6'));
		...
		<span class="help-inline"><?php echo $form->error($locale,'parent_id'); ?></span></div>		
	</div>
	<div class="control-group">
		...
		<?php echo $form->numberField($locale,'category_priority',array('size'=>3,'maxlength'=>3,'class'=>'span6', 'value'=>$this->maxPriority)); ?><span class="help-inline">
	...
	<div class="control-group">
		...
		<span class="help-inline"><?php echo $form->error($locale,'category_status'); ?></span></div>
	</div>       
...
//           print_r($template);
           ...
           ?>
            ...
            <div class="control-group" style="border: 3px solid #E5E5E5">Template
            ...
            <div class="controls">
						 ...
						 if(!empty($templateVal))
						{
							...
							{
								?>
								<div class="controls removeControl">
                <div class="control-group">
                    <?php echo $form->labelEx($locale,'[category_id_'.$count.']'.'title',array('class'=>'control-label')); ?>
                            <div class="controls">
                    <?php echo $form->textField($locale,'[category_id_'.$count.']'.'title',array('size'=>60,'maxlength'=>250,'class'=>'span6','value'=>$title)); ?>
                    <span class="help-inline"><?php echo $form->error($locale,'title'); ?></span></div>
                </div>
                <div class="control-group">
                    <?php echo $form->labelEx($locale,'[category_id_'.$count.']'.'description',array('class'=>'control-label')); ?>
                            <div class="controls">
                    <?php echo $form->textArea($locale, '[category_id_'.$count.']'.'description', array('class'=>'span7','maxlength' => 1000, 'rows' => 8,'value'=>$description,'style'=>"width: 468px; height: 131px;")); ?>
                ...
                <div class="control-group">
                    <?php echo $form->labelEx($locale,'[category_id_1]'.'title',array('class'=>'control-label')); ?>
                            <div class="controls">
                    <?php echo $form->textField($locale,'[category_id_1]'.'title',array('size'=>60,'maxlength'=>250,'class'=>'span6','value'=>$title)); ?>
                    <span class="help-inline"><?php echo $form->error($locale,'title'); ?></span></div>
                </div>
                <div class="control-group">
                    ...
                    <span class="help-inline"><?php echo $form->error($locale,'description'); ?></span></div>
						...
						?>	
							<div class="addRemove">
								<a href="javascript:void(0)" id="addmore" onclick="addmoreCatTemplate();" ><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/add-btn.png"></img></a>
