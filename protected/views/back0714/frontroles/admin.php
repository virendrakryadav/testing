...
<div class="actions"><a class="btn green" href="<?php echo Yii::app()->createUrl('frontroles/create')?>">
	...
	'columns'=>array(
		...
		//'role_permission',
            array(
                    ...
                    'type' => 'raw',
                    'value' => 'UtilityHtml::renderPermissions($data->role_permission)',
            ...
            array(
                    'header' => Yii::t('admin_roles_admin','Role Permission Front'),
                    'type' => 'raw',
                    'value' => 'UtilityHtml::renderPermissions($data->role_permission_front)',
                    'name' => 'role_permission_front',
                'headerHtmlOptions'=>array(
                            'class' => 'grid_permissions'
                        ),
